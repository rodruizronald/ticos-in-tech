...
func (r *Repository) Create(ctx context.Context, job *Job) error {
    ...
    if err != nil {
        ...
        if errors.As(err, &pgErr) && pgErr.Code == "23505" {
            return &ErrDuplicate{Signature: job.Signature}
        }
...
// JobFilter defines the available filters for job queries
...
func (r *Repository) List(ctx context.Context, filter JobFilter) ([]*Job, error) {
